/*
 * Limit_Time_Recharge_Manager.h
 *
 *  Created on: 2014-07-02
 *      Author: xiaoliang
 */

#ifndef LIMIT_TIME_RECHARGE_MANAGER_H_
#define LIMIT_TIME_RECHARGE_MANAGER_H_
...
class Limit_Time_Recharge_Manager {

public:
	Limit_Time_Recharge_Manager();
	virtual ~Limit_Time_Recharge_Manager();
	void reset(void);
...
typedef Singleton<Limit_Time_Recharge_Manager> Limit_Time_Recharge_Manager_Single;
#define LIMIT_TIME_RECHARGE_MANAGER    (Limit_Time_Recharge_Manager_Single::instance())
