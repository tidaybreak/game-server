...
Date_Time::Date_Time(void) : day_(0), month_(0), year_(0), hour_(0), minute_(0), second_(0), microsec_(0), wday_(0), isdst_(-1) {
	this->update ();
}


Date_Time::Date_Time(const Time_Value &timevalue) : day_(0), month_(0), year_(0), hour_(0), minute_(0), second_(0), microsec_(0), wday_(0), isdst_(-1){
	this->update (timevalue);
}

Date_Time::Date_Time(long day, long month, long year, long hour, long minute, long second, long microsec, long wday, int isdst)
 : day_ (day), month_ (month), year_ (year), hour_ (hour), minute_ (minute), second_ (second), microsec_ (microsec), wday_ (wday), isdst_ (isdst) {
...
int Date_Time::isdst(void) const {
	return isdst_;
}
